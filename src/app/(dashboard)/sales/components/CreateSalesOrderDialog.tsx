...
export function CreateSalesOrderDialog({ customers, products }: CreateSalesOrderDialogProps) {
    ...
    const handleSave = async () => {
        ...
        await createSalesOrder(customerId, items);
        setOpen(false);
        setCustomerId("");
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button>
                    <Plus className="mr-2 h-4 w-4" /> {t("sales.newOrder")}
                </Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                    <DialogTitle>{t("sales.newOrder")}</DialogTitle>
                    <DialogDescription>
                        {t("sales.newOrderDescription")}
                    </DialogDescription>
                </DialogHeader>
                ...
                <DialogFooter>
                    <Button onClick={handleSave}>{t("sales.createOrder")}</Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
    );
